...
public class SubtractItemCount extends JFrame
        
{
    ...
    // Thinking of using one App manager variable for the entire
    // manager view process....
    // Make constructor setting manager variable with App parameter
    
    
    public SubtractItemCount(String name) {
        super(name);
    }
/*  
...
*/    
    public static void subView(App mgmt, Manager mgmtIn) {
    ...
    private static void createGUI() {
        ...
        SubtractItemCount frame = new SubtractItemCount("Subtract Inventory");
  ...
  //      frame.setPreferredSize(new Dimension(500,700));
    ...
    private void addComponentsToPane() {
		    	...
		    	if (id == KeyEvent.VK_ENTER)
		    	{
			    	try
		    		{
			    		if(isDigit(qohArea.getText()))
			    			subtractItem(manager.search(itemArea.getText()));
		    		}
		...
		lblText = new JLabel();
		lblText.setText("<html><body style=\"color:red\">Enter Item Number <br> Then Quantity To Subtract</body></html>");
    ...
    private void south()
    {
    	...
    	GridLayout grid = new GridLayout(0, 6, 0, 0);
   ...
   // 	itemPanel.setBorder(BorderFactory.createLineBorder(Color.GREEN, 5));
    ...
    private void north()
    {
    	...
    	lblId.setText("   Item Adjustment - Minus Count");
    ...
    private void subtractItem(Item item)
    {
    	...
    	if(isDigit(qohArea.getText()))
    	{
    		...
    		{	
    			// Update database
    			manager.subtractQoh(managerIn, item, Integer.parseInt(qohArea.getText()));
    		}
    	}
